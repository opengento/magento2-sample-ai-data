...
{
    public const COMMAND = 'sampleaidata:product';
    public const KEYWORD = 'keyword';
    public const MAX_PRODUCTS = 'max-products';
    private const DESCRIPTION_LENGTH = 'description-length';
    public const WITH_CATEGORIES_OPTION = 'with-categories';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $withCategories = $input->getOption(self::WITH_CATEGORIES_OPTION);
